...
class _KamarDetailScreenState extends State<KamarDetailScreen> {
  ...
  Future<void> _konfirmasiLunas(Map<String, dynamic> inv) async {
    ...
    try {
      ...
      try {
        final String? userPenyewaId =
            await NotificationService.getPenyewaUserId(inv['id_sewa']);
        if (userPenyewaId != null) {
          ...
          await NotificationService.sendNotification(
            ...
            pesan:
                'Pembayaran tagihan sebesar $formattedNominal Anda telah dikonfirmasi dan dinyatakan LUNAS. Terima kasih!',
            kategori: 'penyewa',
          );
        }
      } catch (e) {
              ...
              child: ClipRRect(
                ...
                child: Image.network(
                  ...
                  errorBuilder: (context, error, stackTrace) => const SizedBox(
                    height: 200,
                    child: Center(child: Text('Gagal memuat foto KTP')),
                  ),
                ),
              ),
            ),
              ...
              Row(
                children: [
                  CircleAvatar(
                    ...
                    backgroundColor: const Color(0xFFE0F2F1),
                    backgroundImage:
                        (_detailPenyewaData?['foto_profil_url'] != null &&
                            _detailPenyewaData!['foto_profil_url']
                                .toString()
                                .isNotEmpty)
