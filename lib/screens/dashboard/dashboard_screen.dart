...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  Widget _buildBeranda(BuildContext context, Color primaryColor) {
    ...
    return StreamBuilder<List<Map<String, dynamic>>>(
      stream: Supabase.instance.client.from('kamar').stream(primaryKey: ['id_kamar']),
          ...
          builder: (context, pemasukanSnapshot) {
            return StreamBuilder<List<Map<String, dynamic>>>(
              ...
              builder: (context, invoiceSnapshot) {
                ...
                int terisiCount = 0;
                int kosongCount = 0;
                if (kamarSnapshot.hasData) {
                  for (final kamar in kamarSnapshot.data!) {
                ...
                if (pemasukanSnapshot.hasData) {
                  for (final pem in pemasukanSnapshot.data!) {
                ...
                // Calculate paid invoices vs total rooms
                int paidRoomsCount = 0;
                if (invoiceSnapshot.hasData) {
                  for (final inv in invoiceSnapshot.data!) {
                ...
                if (invoiceSnapshot.hasData) {
                  unpaidInvoices = invoiceSnapshot.data!
